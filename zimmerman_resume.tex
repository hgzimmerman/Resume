...
%    Coherence: & Collaborated on a cross-platform API for streaming sensor data from Android and iOS devices to a JVM compatible computer.\\ \cline{2-2}
    ...
    {HLWNPA:} &  I wrote an interpreted expression based programming language using Rust and its parser combinator library Nom. \\ \cline{2-2}
    ...
    %\href{https://github.com/thatapplefreak/Equity-Tracker} %Repo is private and not mine, bad for resume
